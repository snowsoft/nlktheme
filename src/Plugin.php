...
abstract class Plugin {
    ...
    public function render()
    {
        ...
        $path = $this->theme->getThemeNamespace('plugin.'.$this->template);
        ...
        if(!$this->view->exists($path)){
            throw new UnknownWidgetFileException("Plugin view [$this->template] not found.");
        }

        $plugin = $this->view->make($path, $this->data)->render();
